...
<style>
  .tag{display:inline-flex;align-items:center;justify-content:center;gap:.3rem;padding:.25rem .55rem .25rem .7rem;border:0;border-radius:999px;background:var(--ui-tag);color:var(--ui-text);font-family:inherit;font-size:.88rem;font-weight:400;line-height:1.3;text-decoration:none;vertical-align:middle;margin:0;width:auto;min-height:0}
