...
Rollback requires the verified pre-migration backup: stop every updated process, restore that backup while writers remain stopped, then start the old release. Never point the old release at a database after `0004_recipe_views` has been applied.
